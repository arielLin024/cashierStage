...
export const payment = {
  ...
  paymentMethod: ':nth-child(3) > dt',
  paymentMethodTitle: '付款方式 Payment method',
  paymentMethodField: ':nth-child(3) > dd',
  paymentMethodContent: 'ATM櫃員機',
  accountTitle: '/html/body/div[1]/div[2]/div/div[4]/dl[1]/dt',
  accountContent: 'ATM繳費帳號',
};
